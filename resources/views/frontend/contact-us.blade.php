...
<head>
  ...
  <link rel="stylesheet" href="frontend/assets/css/contact-us.css">
...
<body>
          ...
          <div class="mobile__nav__menu">
            <div class="mobile__menu__container">
              <ul class="mobile__menu__list">
                <li class="mobile__menu__list__item"><a href="/" class="mobile__menu__list__link">Home</a>
                </li>
            ...
            <div class="col-sm">
                <div>
                    <div class="contact-extra">
                        ...
                        <p class="subhead-text" id="st-1"><a href="mailto:Help@mycustomer.com">Help@mycustomer.com</a></p>
                        <p class="subhead">Working Hours: 9 AM - 11 PM</p>
                        <div class="map-area">
                            <iframe class="map-iframe" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3964.098727562492!2d3.3773159144495124!3d6.509186125136247!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103b8cf61c9c63c5%3A0xf54f4044acbfc478!2sThe%20HNG%20Internship!5e0!3m2!1sen!2sng!4v1592601378471!5m2!1sen!2sng" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                        </div>
                        <p class="subhead">Find us at,</p>
                        <p class="subhead-text">HNG <br> 3 Birrel Ave, Sabo yaba 100001, <br> Lagos, Nigeria.</p>
                    </div>
                </div>
            </div>
        </div>
  ...
  <script src="frontend/assets/js/contact-us.js"></script>
</body>
</html>
