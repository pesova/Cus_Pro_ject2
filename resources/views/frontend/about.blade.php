        ...
        <section id="about-header">
            <div class="about-content">
                <div class="about-heading">
                    ...
                    <p class="about-heading-caption">We help small businesses collect money and automatically send them reminders when it's time to pay.</p>
                </div>
            </div>
        </section>
      </div>
        ...
        <div class="container ">
          ...
          <section id="about-profile">
            <div class="about-profile-image">
                <img src="./frontend/assets/images/Group of Black Men and Women in Office Setting.svg" alt="our_company">
            </div>
            <div class="about-profile-content">
                <h2 class="about-profile-content-heading">Our Company</h2>
                <p> Voluptatibus, necessitatibus vitae impedit tempora quidem dolores at ad mollitia. Odit, unde obcaecati. Culpa, tempore aperiam? Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sit egestas enim massa urna varius. Cursus etiam sem nec enim et vitae.</p>
            </div>
        </section>
        </div>
