        ...
        <div class="footer__menu">
          <div class="footer__menu__container">
            <ul class="footer__menu__list">
              <li class="footer__menu__list__item"><a href="{{ route('home') }}" class="footer__menu__list__link">Home</a></li>
              <li class="footer__menu__list__item"><a href="{{ route('about') }}" class="footer__menu__list__link">About</a>
              </li>
              <li class="footer__menu__list__item"><a href="{{ route('faq') }}" class="footer__menu__list__link">FAQ</a></li>
              <li class="footer__menu__list__item"><a href="{{ route('contact') }}" class="footer__menu__list__link">Contact
                  Us</a></li>
            </ul>
          </div>
        </div>
