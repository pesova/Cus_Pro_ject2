                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group mx-sm-3 mb-2">
                                                    <select name="status" id="" class="form-control" required>
                                                        ...
                                                        <option value="New"
                                                                @if($response->data->complaint->status =="New") selected @endif>
                                                            New
                                                        </option>
                                                        <option value="Pending"
                                                                @if($response->data->complaint->status =="Pending") selected @endif>
                                                            Pending
                                                        </option>
                                                        <option value="Resolved"
                                                                @if($response->data->complaint->status =="Resolved") selected @endif>
                                                            Resolved
                                                        </option>
                                                        <option value="Closed"
                                                                @if($response->data->complaint->status =="Closed") selected @endif>
                                                            Closed
                                                        </option>
                                                    </select>
                                                </div>
